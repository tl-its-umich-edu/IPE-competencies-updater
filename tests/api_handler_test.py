...
def test_check_if_response_successful_when_valid(api_handler):
...
def test_check_if_response_unsuccessful_when_valid(api_handler):
    """check_if_response_successful returns True with a valid Response."""
...
def test_check_if_response_successful_with_invalid_json(api_handler):
...
def test_api_with_no_errors(ipe_props, api_handler):
